...
interface Message {
  ...
  read: boolean;
  iv?: string; // For end-to-end encryption (if implemented)
}
 ...
 * @access Private
 */
router.get('/:userId/:partnerId', validateAuthToken, async (req: Request, res: Response) => {
  try {
 ...
 * @access Private
 */
router.post('/:userId/:partnerId', validateAuthToken, async (req: Request, res: Response) => {
  try {
    const { userId, partnerId } = req.params;
 ...
 * @access Private
 */
router.delete('/:userId/:partnerId/:messageId', validateAuthToken, async (req: Request, res: Response) => {
  try {
 ...
 * @access Private
 */
router.get('/:userId/conversations', validateAuthToken, async (req: Request, res: Response) => {
  try {
 ...
 * @access Private
 */
router.put('/:userId/:partnerId/read', validateAuthToken, async (req: Request, res: Response) => {
  try {
    const { userId, partnerId } = req.params;
    const authReq = req as AuthRequest;
 ...
 */
async function updateConversationMetadata(senderId: string, recipientId: string, message: any) {
  const batch = db.batch();
