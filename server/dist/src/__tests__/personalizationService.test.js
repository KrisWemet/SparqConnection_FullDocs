...
describe('PersonalizationService', () => {
    ...
    describe('getPersonalizedContent', () => {
        it('should return personalized content based on user preferences', async () => {
            ...
            db.collection('userPreferences').doc(mockUserId).get
                .mockResolvedValue({
                exists: true,
                data: () => mockPreferences
            });
            db.collection('prompts').where
                .mockReturnValue({
        ...
        it('should create new preferences for first-time users', async () => {
            ...
            db.collection('promptResponses').where
                .mockReturnValue({
            ...
            db.collection('quizResponses').where
                .mockReturnValue({
                orderBy: jest.fn().mockReturnValue({
                    limit: jest.fn().mockReturnValue({
            ...
            db.collection('gamification').doc(mockUserId).get
                .mockResolvedValue({
                exists: true,
